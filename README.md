...
| ------------------- | --------------- | ----------------------------------- |
| 1.1.2.290         | 2.9.0           | `uv pip install xtr-warp-rs==1.1.2.290` |
| 1.1.2.280         | 2.8.0           | `uv pip install xtr-warp-rs==1.1.2.280` |
| 1.1.2.270         | 2.7.0           | `uv pip install xtr-warp-rs==1.1.2.270` |
