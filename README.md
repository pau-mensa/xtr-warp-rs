...
| ------------------- | --------------- | ----------------------------------- |
| 1.1.1.290         | 2.9.0           | `uv pip install xtr-warp-rs==1.1.1.290` |
| 1.1.1.280         | 2.8.0           | `uv pip install xtr-warp-rs==1.1.1.280` |
| 1.1.1.270         | 2.7.0           | `uv pip install xtr-warp-rs==1.1.1.270` |
